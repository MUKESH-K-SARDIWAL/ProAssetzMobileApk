import { View, Text, Image, ImageBackground, TouchableOpacity, StyleSheet, TouchableWithoutFeedback, Platform, } from "react-native";
...
const SmallCard = (props) => {
  ...
  const [sendModelVisible, setsendModelVisible] = useState(true)
  return (
    <View>
      <View style={{
        flexDirection: "row",
