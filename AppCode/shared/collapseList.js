        ...
        <View style={styles.flatBox}>
            ...
            >
                <Image
                    ...
                    resizeMode="contain"
                />
                <Text style={{ color: TxtColor ,marginLeft:20}}>{props.item.txt}</Text>
            </View>

            <Text style={{ color: TxtColor,marginLeft:20 }}>{props.item.no}</Text>
            <View style={styles.rowStyle}>
                <UpIcon name="caretup" size={12} color={"#14AE5C"} style={{marginLeft:20}}/>
                <Text style={{ color: "#14AE5C", paddingHorizontal: "1%",marginLeft:2 }}>
                    {props.item.per}
                </Text>
            </View>
        </View>
