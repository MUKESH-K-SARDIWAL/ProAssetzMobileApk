  ...
  return (
    <View style={{ backgroundColor: "#111111", borderTopLeftRadius: 30, borderTopRightRadius: 30 }}>
      ...
      <View style={{ marginHorizontal: '8%', marginTop: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        <Text style={{ fontSize: 12,color: '#FFA629' }}>Fees :<Text style={{ fontSize: 12,  color: '#FFA629' }}> 0.00</Text></Text>

        <Text style={{ fontSize: 12, color: '#FFA629' }}>Total Amount :<Text style={{ fontSize: 12, color: '#FFA629' }}> 0.00</Text></Text>
      </View>
      <View style={{ marginHorizontal: '7.5%' }}>
        <View style={{ marginVertical: 8 }}>
          ...
          <View style={{ flexDirection: 'row', marginHorizontal: 8, alignItems: 'center', justifyContent: 'space-between', marginTop: 12 }}>
            <View>
              <Text style={{ fontSize: 12, color: '#878787' }}>25%</Text>
            </View>
            <View>
              <Text style={{ fontSize: 12,  color: '#878787', }}>50%</Text>
            </View>
            <View>
              <Text style={{ fontSize: 12,  color: '#878787',  }}>75%</Text>
            </View>
            <View>
              <Text style={{ fontSize: 12, color: '#878787', }}>100%</Text>
            </View>
          </View>
        </View>
      </View>
